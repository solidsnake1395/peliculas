...
<?php
  ...
  if ( isset($puntuar) )
  {
          ...
          $result_query = mysql_query($sql_query) or die("Error en la sentencia SQL<br><br>".$sql_query."<br><br>");
          $reg_query = mysql_fetch_array ($result_query) ;
          if ($reg_query) //El usuario ya ha puntuado esa pelicula  -> se actualiza su puntuación
          {
            ...
            $result_update = mysql_query($sql_update) or die("Error en la sentencia SQL<br><br>".$sql_update."<br><br>");
            if (trim($comentario) == "")
          ...
          else //el usuario no ha puntuado la película
          {
            ...
            $result_update = mysql_query($sql_insert) or die("Error en la sentencia SQL<br><br>".$sql_insert."<br><br>");
  ...
  $result_pelicula = mysql_query($sql_pelicula) or die("Error en la sentencia SQL<br><br>".$sql."<br><br>");
  $reg_pelicula = mysql_fetch_array ($result_pelicula) ;
...
<?php
          ...
          $result_puntuacion = mysql_query($sql_puntuacion) or die("Error en la sentencia SQL<br><br>".$sql_puntuacion."<br><br>");
          $reg_puntuacion = mysql_fetch_array ($result_puntuacion) ;
...
<?php
          ...
          $result_mipuntuacion = mysql_query($sql_mipuntuacion) or die("Error en la sentencia SQL<br><br>".$sql_mipuntuacion."<br><br>");
          $reg_mipuntuacion = mysql_fetch_array ($result_mipuntuacion) ;
          if ( $reg_mipuntuacion)
          {
